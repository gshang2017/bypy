...
#
    env = {
        'CFLAGS': CFLAGS +
        f' -DHAVE_LOAD_EXTENSION -I{PREFIX}/include/ncursesw' + ' -I/opt/cross/usr/include'
...
#
        conf += f' --with-system-ffi --enable-shared --prefix={build_dir()} --with-build-python=/usr/bin/python CONFIG_SITE=/bypy/patches/config.site '
