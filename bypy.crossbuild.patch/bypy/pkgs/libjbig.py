...
#
import os
from bypy.constants import UNIVERSAL_ARCHES, ismacos, iswindows, islinux
...
#
    if islinux:
        if os.path.exists('/opt/armv7l-linux-musleabihf-cross'):
            replace_in_file('libjbig/Makefile', 'CC = gcc', f'CC = /opt/armv7l-linux-musleabihf-cross/bin/armv7l-linux-musleabihf-gcc ')
        else:
            replace_in_file('libjbig/Makefile', 'CC = gcc', f'CC = /opt/aarch64-linux-musl-cross/bin/aarch64-linux-musl-gcc ')
    run('make', 'lib')
