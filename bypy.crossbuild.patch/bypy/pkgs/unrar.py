...
#
    replace_in_file('makefile', 'CXX=c++', '')
    replace_in_file('makefile', 'STRIP=strip', '')   
    replace_in_file('makefile', 'AR=ar', '')
    replace_in_file('makefile', 'LDFLAGS=-pthread', 'LDFLAGS+=-pthread')
    if iswindows:
