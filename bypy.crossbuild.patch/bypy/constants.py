...
if iswindows:
    ...
    #LD_LIBRARY_PATH= worker_env['LD_LIBRARY_PATH'] = '-L' + os.path.join(PREFIX, 'lib')
    #PKG_CONFIG_PATH = worker_env['PKG_CONFIG_PATH'] =  os.path.join( PREFIX, 'lib', 'pkgconfig')
    PKG_CONFIG_LIBDIR = worker_env['PKG_CONFIG_LIBDIR'] = os.path.join( PREFIX, 'lib', 'pkgconfig')  + ':/opt/cross/usr/lib/pkgconfig:/opt/cross/usr/share/pkgconfig'
