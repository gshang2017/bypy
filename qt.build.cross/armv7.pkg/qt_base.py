...
from bypy.utils import ModifiedEnv, replace_in_file, run, run_shell, apply_patch
...
def main(args):
 ...
 with ModifiedEnv(**env):
    ...
    if islinux:
        ...
        conf += (' -opengl es2 -device-option CROSS_COMPILE=arm-linux-gnueabi-  -sysroot /opt/cross  -xplatform linux-arm-gnueabi-g++  -bundled-xcb-xinput -xcb -glib -openssl -qt-pcre'
